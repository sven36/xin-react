...
/******/ 	var hotCurrentHash = "4437b101e90de80a866e"; // eslint-disable-line no-unused-vars
...
const server = __WEBPACK_IMPORTED_MODULE_1_http___default.a.createServer(__WEBPACK_IMPORTED_MODULE_0__server__["default"]);

let currentApp = __WEBPACK_IMPORTED_MODULE_0__server__["default"];

server.listen(Object({"NODE_ENV":"development","PUBLIC_URL":""}).PORT || 3000, error => {
  if (error) {
    console.log(error);
  }
...
if (true) {
  ...
  module.hot.accept("./react-server/server.js", function(__WEBPACK_OUTDATED_DEPENDENCIES__) { /* harmony import */ __WEBPACK_IMPORTED_MODULE_0__server__ = __webpack_require__("./react-server/server.js"); /* harmony import */ __WEBPACK_IMPORTED_MODULE_0__server___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__server__); (() => {
    console.log('🔁  HMR Reloading `./server`...');
    server.removeListener('request', currentApp);
    const newApp = __webpack_require__("./react-server/server.js").default;
...
__webpack_require__("webpack/hot/poll?300");
...
module.exports = webpack/hot/poll?300;
